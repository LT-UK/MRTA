...
init.Nt = 50   # number of tasks 200, 60, 50   
init.evs_scale = 3  # scale in plot figures, scale = 10**evs_scale

init.Na = 12   # 12 or 4, fixed number of agents for tradeoffs 15 for DSTA
...
init.MC_ctr = 5    # The number of Monte Carlo loops.

init.Na_start = 4   # 10, 4
init.Na_end = 21    # 51, 21
init.Na_step = 2    # 5,  2
